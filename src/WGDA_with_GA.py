...
class LUNA_3D_Gaussian(Dataset):
    ...
    def __getitem__(self, index):
        ...
        lung_img = self.augmentator(image=guass_img)
        lung_img = lung_img['image']
        guass_img_norm = normalizePlanes(lung_img) 
...
##### Standard Evaluation for Standard Dose Patients#####
